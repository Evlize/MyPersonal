...
import com.zxp.web.admin.AttachController;
...
//        }
    ...
    public static String saveFile(MultipartFile file) throws IOException {
        String directoryPath = "/images/avatar/"; // 修改为你实际的路径
        Files.createDirectories(Paths.get(directoryPath)); // 如果目录不存在则创建
        ...
        // 返回保存路径
        return "/images/avatar/" + originalFilename; // 修改为实际的Web访问路径
    }
