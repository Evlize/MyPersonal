...
public class Comment {
    ...
    private Integer commentsNum2;  // 评论总量
    private String status;     // 评论状态，默认审核通过approved

    public Integer getCommentsNum2() {
        return commentsNum2;
    }



    public void setCommentsNum2(Integer commentsNum2) {
